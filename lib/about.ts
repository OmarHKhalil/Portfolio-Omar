...
export const education = [
  {
    ...
    field: "Artificial Intelligence (AI) & Backend Development",
    institution: "Arab International University (AIU)",
    year: "2021-2026",
    highlights: [
      "Deep Learning & Computer Vision (YOLO, ResNet)",
      "Applied AI Systems & RAG Frameworks (LangChain)",
      "Advanced Backend Engineering & API Integration",
      "Academic Excellence (A- Grade in Junior Project)"
    ],
  },
];;
